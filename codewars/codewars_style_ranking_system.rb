=begin
Codewars style ranking system by Vladislav Trotsenko
...
Business Rules:
    ...
    The only acceptable range of rank activity_ranks is
    -8,-7,-6,-5,-4,-3,-2,-1,1,2,3,4,5,6,7,8.
    Any other activity_rank should raise an error.

The progress is scored like so:

    Completing an activity that is ranked the same as that of the user's
    will be worth 3 points. Completing an activity that is ranked one ranking
    lower than the user's will be worth 1 point. Any activities completed that
    are ranking 2 levels or more lower than the user's ranking will be ignored
    ...
    the more the progression will be increased. The formula is 10 * d * d
